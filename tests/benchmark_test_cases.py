...
STRUCTURAL_COHERENCE_TEST_CASES = [
    ...
    pytest.param(
        ...
        [EvalMetrics.STRUCTURAL_COHERENCE],
        {
            "STRUCTURAL_COHERENCE": {"exon_chain": {"tp": 0, "fp": 1, "fn": 1, "tn": 0}, "exon_chain_subset": {"tp": 0, "fp": 1, "fn": 1, "tn": 0}, "exon_chain_superset": {"tp": 0, "fp": 1, "fn": 1, "tn": 0}, "boundary_shift_count": 0, "boundary_shift_total": 0, "boundary_shift_offsets": [], "exon_recall_per_transcript": 0.0, "hallucinated_exon_count_per_transcript": 2, "transcript_match_class": 'substitution', "segment_count_delta": -1, "intron_chain": {"tp": 0, "fp": 1, "fn": 1, "tn": 0}, "intron_chain_subset": {"tp": 0, "fp": 1, "fn": 1, "tn": 0}, "intron_chain_superset": {"tp": 0, "fp": 1, "fn": 1, "tn": 0}, "splice_site_results": {"both_correct": 0, "donor_only": 0, "acceptor_only": 0, "neither": 0, "donor_tp": 0, "donor_fp": 0, "donor_fn": 0, "acceptor_tp": 0, "acceptor_fp": 0, "acceptor_fn": 0, "gt_malformed_junctions": 0, "pred_malformed_junctions": 0}},
        },
    ...
    pytest.param(
        ...
        [EvalMetrics.STRUCTURAL_COHERENCE],
        {
            "STRUCTURAL_COHERENCE": {"exon_chain": {"tp": 0, "fp": 1, "fn": 1, "tn": 0}, "exon_chain_subset": {"tp": 0, "fp": 1, "fn": 1, "tn": 0}, "exon_chain_superset": {"tp": 0, "fp": 1, "fn": 1, "tn": 0}, "boundary_shift_count": 0, "boundary_shift_total": 0, "boundary_shift_offsets": [], "exon_recall_per_transcript": 0.5, "hallucinated_exon_count_per_transcript": 2, "transcript_match_class": 'partial_overlap', "segment_count_delta": -1, "intron_chain": {"tp": 0, "fp": 1, "fn": 1, "tn": 0}, "intron_chain_subset": {"tp": 0, "fp": 1, "fn": 1, "tn": 0}, "intron_chain_superset": {"tp": 0, "fp": 1, "fn": 1, "tn": 0}, "splice_site_results": {"both_correct": 0, "donor_only": 0, "acceptor_only": 0, "neither": 0, "donor_tp": 0, "donor_fp": 0, "donor_fn": 0, "acceptor_tp": 0, "acceptor_fp": 0, "acceptor_fn": 0, "gt_malformed_junctions": 0, "pred_malformed_junctions": 0}},
        },
...
MULTI_SEQUENCE_TEST_CASES = [
    pytest.param(
        ...
        [EvalMetrics.INDEL, EvalMetrics.REGION_DISCOVERY, EvalMetrics.BOUNDARY_EXACTNESS, EvalMetrics.NUCLEOTIDE_CLASSIFICATION],
        {
            ...
            "REGION_DISCOVERY": {"neighborhood_hit": {"precision": 0.0, "recall": 0.0}, "perfect_boundary_hit": {"precision": 0.0, "recall": 0.0}, "containment": {"internal_rate": None, "full_coverage_rate": None}},
