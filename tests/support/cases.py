...
SINGLE_SEQUENCE_TEST_CASES = [
    pytest.param(
        ...
        ],
        {
            "INDEL": {
                "by_boundary": {
                    "five_prime_terminal_exon": {"5_prime_extensions": [3], "3_prime_deletions": [3]},
                    "internal_exon": {
                        "whole_insertions": [4],
                        "3_prime_extensions": [2],
                        "5_prime_deletions": [1],
                    },
            ...
            "REGION_DISCOVERY": {
                "neighborhood_hit": {"tp": 2, "fp": 1, "fn": 1, "tn": 0},
                "internal_hit": {"tp": 0, "fp": 3, "fn": 3, "tn": 0},
                "full_coverage_hit": {"tp": 0, "fp": 3, "fn": 3, "tn": 0},
                "perfect_boundary_hit": {"tp": 0, "fp": 3, "fn": 3, "tn": 0},
            },
            "BOUNDARY_EXACTNESS": {
                "first_sec_correct_3_prime_boundary": 0,
                "last_sec_correct_5_prime_boundary": 0,
                "iou_scores": [0.25, 0.5714285714285714],
                "fuzzy_metrics": {"boundary_offsets": [(-3, -3), (1, 2)], "total_gt": 3},
            },
    ...
    pytest.param(
        ...
        ],
        {
            ...
            "REGION_DISCOVERY": {
                "neighborhood_hit": {"tp": 3, "fp": 6, "fn": 0, "tn": 0},
                "internal_hit": {"tp": 3, "fp": 6, "fn": 0, "tn": 0},
                "full_coverage_hit": {"tp": 1, "fp": 8, "fn": 2, "tn": 0},
                "perfect_boundary_hit": {"tp": 1, "fp": 8, "fn": 2, "tn": 0},
            },
            "BOUNDARY_EXACTNESS": {
                "first_sec_correct_3_prime_boundary": 1,
                "last_sec_correct_5_prime_boundary": 1,
                "iou_scores": [0.2, 0.2, 1.0],
                "fuzzy_metrics": {"boundary_offsets": [(0, -4), (0, -4), (0, 0)], "total_gt": 3},
            },
    ...
    pytest.param(
        ...
        ],
        {
            ...
            "REGION_DISCOVERY": {
                ...
                "internal_hit": {"tp": 0, "fp": 0, "fn": 3, "tn": 0},
                "full_coverage_hit": {"tp": 0, "fp": 0, "fn": 3, "tn": 0},
                "perfect_boundary_hit": {"tp": 0, "fp": 0, "fn": 3, "tn": 0},
            },
            "BOUNDARY_EXACTNESS": {
                "first_sec_correct_3_prime_boundary": 0,
                "last_sec_correct_5_prime_boundary": 0,
                "iou_scores": [],
                "fuzzy_metrics": {"boundary_offsets": [], "total_gt": 3},
            },
    ...
    pytest.param(
        ...
        ],
        {
            ...
            "REGION_DISCOVERY": {
                ...
                "full_coverage_hit": {"tp": 0, "fp": 3, "fn": 0, "tn": 0},
                "perfect_boundary_hit": {"tp": 0, "fp": 3, "fn": 0, "tn": 0},
            },
            "BOUNDARY_EXACTNESS": {
                "first_sec_correct_3_prime_boundary": 0,
                "last_sec_correct_5_prime_boundary": 0,
                "iou_scores": [],
                "fuzzy_metrics": {"boundary_offsets": [], "total_gt": 0},
            },
    ...
    pytest.param(
        ...
        {
            "REGION_DISCOVERY": {
                "neighborhood_hit": {"tp": 4, "fp": 0, "fn": 0, "tn": 0},
                "internal_hit": {"tp": 1, "fp": 3, "fn": 3, "tn": 0},
                "full_coverage_hit": {"tp": 4, "fp": 0, "fn": 0, "tn": 0},
                "perfect_boundary_hit": {"tp": 1, "fp": 3, "fn": 3, "tn": 0},
            },
            "BOUNDARY_EXACTNESS": {
                "first_sec_correct_3_prime_boundary": 1,
                "last_sec_correct_5_prime_boundary": 1,
                "iou_scores": [0.4, 0.7142857142857143, 1.0, 0.6666666666666666],
                "fuzzy_metrics": {"boundary_offsets": [(-3, 0), (-1, 1), (0, 0), (0, 1)], "total_gt": 4},
            },
    ...
    pytest.param(
        ...
        ],
        {
            ...
            "REGION_DISCOVERY": {
                ...
                "internal_hit": {"tp": 0, "fp": 1, "fn": 2, "tn": 0},
                "full_coverage_hit": {"tp": 0, "fp": 1, "fn": 2, "tn": 0},
                "perfect_boundary_hit": {"tp": 0, "fp": 1, "fn": 2, "tn": 0},
            },
            "BOUNDARY_EXACTNESS": {
                "first_sec_correct_3_prime_boundary": 0,
                "last_sec_correct_5_prime_boundary": 0,
                "iou_scores": [0.125],
                "fuzzy_metrics": {"boundary_offsets": [(3, 4)], "total_gt": 2},
            },
    ...
    pytest.param(
        ...
        {
            "REGION_DISCOVERY": {
                "neighborhood_hit": {"tp": 3, "fp": 0, "fn": 0, "tn": 0},
                "internal_hit": {"tp": 3, "fp": 0, "fn": 0, "tn": 0},
                "full_coverage_hit": {"tp": 3, "fp": 0, "fn": 0, "tn": 0},
                "perfect_boundary_hit": {"tp": 3, "fp": 0, "fn": 0, "tn": 0},
            },
            "BOUNDARY_EXACTNESS": {
                "first_sec_correct_3_prime_boundary": 1,
                "last_sec_correct_5_prime_boundary": 1,
                "iou_scores": [1.0, 1.0, 1.0],
                "fuzzy_metrics": {"boundary_offsets": [(0, 0), (0, 0), (0, 0)], "total_gt": 3},
            },
    ...
    pytest.param(
        ...
        {
            "REGION_DISCOVERY": {
                "neighborhood_hit": {"tp": 1, "fp": 0, "fn": 0, "tn": 0},
                "internal_hit": {"tp": 1, "fp": 0, "fn": 0, "tn": 0},
                "full_coverage_hit": {"tp": 1, "fp": 0, "fn": 0, "tn": 0},
                "perfect_boundary_hit": {"tp": 1, "fp": 0, "fn": 0, "tn": 0},
            },
            "BOUNDARY_EXACTNESS": {
                "first_sec_correct_3_prime_boundary": 1,
                "last_sec_correct_5_prime_boundary": 1,
                "iou_scores": [1.0],
                "fuzzy_metrics": {"boundary_offsets": [(0, 0)], "total_gt": 1},
            },
    ...
    pytest.param(
        ...
        ],
        {
            ...
            "REGION_DISCOVERY": {
                "neighborhood_hit": {"tp": 1, "fp": 0, "fn": 1, "tn": 0},
                "internal_hit": {"tp": 1, "fp": 0, "fn": 1, "tn": 0},
                "full_coverage_hit": {"tp": 0, "fp": 1, "fn": 2, "tn": 0},
                "perfect_boundary_hit": {"tp": 0, "fp": 1, "fn": 2, "tn": 0},
            },
            "BOUNDARY_EXACTNESS": {
                ...
                "last_sec_correct_5_prime_boundary": 0,
                "iou_scores": [0.5],
                "fuzzy_metrics": {"boundary_offsets": [(0, -1)], "total_gt": 2},
            },
    ...
    pytest.param(
        ...
        {
            "REGION_DISCOVERY": {
                "neighborhood_hit": [{"tp": 1, "fp": 0, "fn": 0, "tn": 0}, {"tp": 1, "fp": 0, "fn": 0, "tn": 0}],
                "internal_hit": [{"tp": 1, "fp": 0, "fn": 0, "tn": 0}, {"tp": 1, "fp": 0, "fn": 0, "tn": 0}],
                "full_coverage_hit": [{"tp": 1, "fp": 0, "fn": 0, "tn": 0}, {"tp": 1, "fp": 0, "fn": 0, "tn": 0}],
                "perfect_boundary_hit": [{"tp": 1, "fp": 0, "fn": 0, "tn": 0}, {"tp": 1, "fp": 0, "fn": 0, "tn": 0}],
            },
            "BOUNDARY_EXACTNESS": {
                "first_sec_correct_3_prime_boundary": [1, 1],
                "last_sec_correct_5_prime_boundary": [1, 1],
                "iou_scores": [1.0, 1.0],
                "fuzzy_metrics": {"boundary_offsets": [(0, 0), (0, 0)], "total_gt": 2},
            },
            "NUCLEOTIDE_CLASSIFICATION": {
                "nucleotide": [{"tp": 3, "fp": 0, "fn": 0, "tn": 3}, {"tp": 2, "fp": 0, "fn": 0, "tn": 4}]
            },
        },
        id="mask_test",
    ),
    pytest.param(
        ...
        {
            "INDEL": {
                "by_boundary": {"single_exon_gene": {"5_prime_deletions": [2], "3_prime_deletions": [1]}},
                "exon_opportunities": {"single_exon_gene": 2},
                "n_gt_segments": 2,
                "n_pred_segments": 2,
            },
        },
...
STRUCTURAL_COHERENCE_TEST_CASES = [
    pytest.param(
        ...
        [EvalMetrics.STRUCTURAL_COHERENCE],
        {
            "STRUCTURAL_COHERENCE": {
                "exon_chain": {"tp": 1, "fp": 0, "fn": 0, "tn": 0},
                "exon_chain_subset": {"tp": 1, "fp": 0, "fn": 0, "tn": 0},
                "exon_chain_superset": {"tp": 1, "fp": 0, "fn": 0, "tn": 0},
                "exon_chain_multi": {"tp": 1, "fp": 0, "fn": 0, "tn": 0},
                "exon_chain_multi_subset": {"tp": 1, "fp": 0, "fn": 0, "tn": 0},
                "exon_chain_multi_superset": {"tp": 1, "fp": 0, "fn": 0, "tn": 0},
                "exon_chain_single": {"tp": 0, "fp": 0, "fn": 0, "tn": 0},
                "boundary_shift_count": 0,
                "boundary_shift_total": 0,
                "boundary_shift_offsets": [],
                "exon_recall_per_transcript": 1.0,
                "exon_precision_per_transcript": 1.0,
                "false_exon_count_per_transcript": 0,
                "transcript_match_class": "exact",
                "segment_count_delta": 0,
                "intron_chain": {"tp": 1, "fp": 0, "fn": 0, "tn": 0},
                "intron_chain_subset": {"tp": 1, "fp": 0, "fn": 0, "tn": 0},
                "intron_chain_superset": {"tp": 1, "fp": 0, "fn": 0, "tn": 0},
                "splice_site_results": {
                    "both_correct": 0,
                    "donor_only": 0,
                    "acceptor_only": 0,
    ...
    pytest.param(
        ...
        {
            "STRUCTURAL_COHERENCE": {
                "exon_chain": {"tp": 0, "fp": 1, "fn": 1, "tn": 0},
                "exon_chain_subset": {"tp": 0, "fp": 1, "fn": 1, "tn": 0},
                "exon_chain_superset": {"tp": 0, "fp": 1, "fn": 1, "tn": 0},
                "exon_chain_multi": {"tp": 0, "fp": 1, "fn": 1, "tn": 0},
                "exon_chain_multi_subset": {"tp": 0, "fp": 1, "fn": 1, "tn": 0},
                "exon_chain_multi_superset": {"tp": 0, "fp": 1, "fn": 1, "tn": 0},
                "exon_chain_single": {"tp": 0, "fp": 0, "fn": 0, "tn": 0},
                "boundary_shift_count": 3,
                "boundary_shift_total": 3,
                "boundary_shift_offsets": [
                    {"offset": -1, "position": "terminal"},
                    {"offset": -1, "position": "internal"},
                    {"offset": 1, "position": "terminal"},
                ],
                "exon_recall_per_transcript": 0.0,
                "exon_precision_per_transcript": 0.0,
                "false_exon_count_per_transcript": 3,
                "transcript_match_class": "boundary_shift_terminal",
                "segment_count_delta": 0,
                "intron_chain": {"tp": 0, "fp": 1, "fn": 1, "tn": 0},
                "intron_chain_subset": {"tp": 0, "fp": 1, "fn": 1, "tn": 0},
                "intron_chain_superset": {"tp": 0, "fp": 1, "fn": 1, "tn": 0},
                "splice_site_results": {
                    "both_correct": 0,
                    "donor_only": 0,
                    "acceptor_only": 0,
    ...
    pytest.param(
        ...
        [EvalMetrics.STRUCTURAL_COHERENCE],
        {
            "STRUCTURAL_COHERENCE": {
                ...
                "boundary_shift_total": 0,
                "boundary_shift_offsets": [],
                "exon_recall_per_transcript": 0.6666666666666666,
                "exon_precision_per_transcript": 1.0,
                "false_exon_count_per_transcript": 0,
    ...
    pytest.param(
        ...
        [EvalMetrics.STRUCTURAL_COHERENCE],
        {
            "STRUCTURAL_COHERENCE": {
                ...
                "boundary_shift_offsets": [],
                "exon_recall_per_transcript": 1.0,
                "exon_precision_per_transcript": 0.6666666666666666,
                "false_exon_count_per_transcript": 1,
    ...
    pytest.param(
        ...
        [EvalMetrics.STRUCTURAL_COHERENCE],
        {
            "STRUCTURAL_COHERENCE": {
                ...
                "exon_recall_per_transcript": 0.0,
                "exon_precision_per_transcript": 0.0,
                "false_exon_count_per_transcript": 2,
                "transcript_match_class": "substitution",
                "segment_count_delta": -1,
                "intron_chain": {"tp": 0, "fp": 1, "fn": 1, "tn": 0},
                "intron_chain_subset": {"tp": 0, "fp": 1, "fn": 1, "tn": 0},
                "intron_chain_superset": {"tp": 0, "fp": 1, "fn": 1, "tn": 0},
    ...
    pytest.param(
        ...
        {
            "STRUCTURAL_COHERENCE": {
                "exon_chain": {"tp": 0, "fp": 0, "fn": 0, "tn": 0},
                "exon_chain_subset": {"tp": 0, "fp": 0, "fn": 0, "tn": 0},
                "exon_chain_superset": {"tp": 0, "fp": 0, "fn": 0, "tn": 0},
                "intron_chain": {"tp": 0, "fp": 0, "fn": 0, "tn": 0},
                "intron_chain_subset": {"tp": 0, "fp": 0, "fn": 0, "tn": 0},
                "intron_chain_superset": {"tp": 0, "fp": 0, "fn": 0, "tn": 0},
                "splice_site_results": {
                    "both_correct": 0,
                    "donor_only": 0,
                    "acceptor_only": 0,
    ...
    pytest.param(
        ...
        [EvalMetrics.STRUCTURAL_COHERENCE],
        {
            "STRUCTURAL_COHERENCE": {
                ...
                "boundary_shift_total": 0,
                "boundary_shift_offsets": [],
                "exon_recall_per_transcript": 0.5,
                "exon_precision_per_transcript": 0.6,
                "false_exon_count_per_transcript": 2,
                "transcript_match_class": "partial_overlap",
                "segment_count_delta": -1,
                "intron_chain": {"tp": 0, "fp": 1, "fn": 1, "tn": 0},
                "intron_chain_subset": {"tp": 0, "fp": 1, "fn": 1, "tn": 0},
                "intron_chain_superset": {"tp": 0, "fp": 1, "fn": 1, "tn": 0},
    ...
    pytest.param(
        ...
        [EvalMetrics.STRUCTURAL_COHERENCE],
        {
            "STRUCTURAL_COHERENCE": {
                ...
                "exon_chain_subset": {"tp": 1, "fp": 0, "fn": 0, "tn": 0},
                "exon_chain_superset": {"tp": 1, "fp": 0, "fn": 0, "tn": 0},
                "exon_chain_multi": {"tp": 0, "fp": 0, "fn": 0, "tn": 0},
                "exon_chain_multi_subset": {"tp": 0, "fp": 0, "fn": 0, "tn": 0},
                "exon_chain_multi_superset": {"tp": 0, "fp": 0, "fn": 0, "tn": 0},
                "exon_chain_single": {"tp": 1, "fp": 0, "fn": 0, "tn": 0},
                "boundary_shift_count": 0,
                "boundary_shift_total": 0,
                "boundary_shift_offsets": [],
                "exon_recall_per_transcript": 1.0,
