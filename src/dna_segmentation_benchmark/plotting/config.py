...
PLOT_METADATA: dict[str, PlotMetadata] = {
    ...
    "neighborhood_hit": PlotMetadata(
        ...
        show_tp_tn_fp_fn=True,
        description="Measures how well predicted sections partially overlap ground truth sections. "
                    "Uses 1:1 matching — each GT section is matched to the single best-overlapping "
                    "prediction; unmatched predictions count as FPs.",
    ...
    "internal_hit": PlotMetadata(
        ...
        description="Measures if the matched prediction did not exceed the GT boundaries "
    ...
    "full_coverage_hit": PlotMetadata(
        ...
        description="Measures if the matched prediction contains the entire GT section or more "
    ...
    "perfect_boundary_hit": PlotMetadata(
        ...
        show_tp_tn_fp_fn=True,
        description="Measures if the matched prediction exactly reproduces the GT section's "
                    "boundaries (100%% IoU). Uses 1:1 matching.",
